...
class DataTransformationConfig:
    ...
    transformed_train_label_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR, "train_y.npy")
    transformed_test_label_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR, "test_y.npy")
    transformed_vectorizer_object_file_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, VECTORIZER_OBJECT_FILE_NAME)
    transformed_encoder_object_file_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, ENCODER_OBJECT_FILE_NAME)
