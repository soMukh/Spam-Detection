...
from src.constant.training_pipeline import TARGET_COLUMN, FEATURE_COLUMN
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[SpamhamDetector]:
        try:
            ...
            spamham_detector = SpamhamDetector(bucket_name=bucket_name, model_path=model_path)
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        try:
            ...
            # Load encoder and encode y_test
            encoder = self.utils.load_object(
                self.data_transformation_artifact.transformed_encoder_object_file_path)
            ...
            trained_model_f1_score = f1_score(y_test_encoded, y_hat_trained_model)
            ...
            if best_model is not None:
                ...
                best_model_f1_score = f1_score(y_test_encoded, y_hat_best_model)
                best_model_metric_artifact = calculate_metric(best_model, x_test, y_test_encoded)
